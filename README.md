...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lava-dnf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14668&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lava-dnf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lava-dnf` can be installed with:

```
conda install lava-dnf
```

It is possible to list all of the versions of `lava-dnf` available on your platform with:
